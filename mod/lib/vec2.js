...
// decode a 2D vector data into the target object with optional names
//
// @param {object} tar - the target object to decode vec2 values into
// @param {array/vec2/immutable} iv - the source 2D vector
// @returns {obj/lib/vec2} vec2 library object for chaining
function decode(tar, iv, xn, yn) {
    xn = xn || 'x'
    yn = yn || 'y'
